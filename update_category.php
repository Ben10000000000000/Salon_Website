...
<div class="col-md">
    ...
    <input type="text" class="form-control" id="category" name="category" value="<?php echo $data['name'];?>" required>
    </div>
    <div class="mt-3">
        ...
        if(isset($_REQUEST['Submit'])){
          include('config2.php');
           $id = $_REQUEST["id"];
            ...
            $query = "UPDATE `categories` SET `name`=' $categoryname',`image`='$new_name',`description`='$description' WHERE id='$id'";
            $result = mysqli_query($conn,$query);
            if($result>0){
