                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        ...
                                        <a class="dropdown-item" href="manageservice.php">Manage service</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="managecontact.php">Manage contact</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="teammember.php">Team member</a>
                                        <a class="dropdown-item" href="manageteammember.php">Manage Team Member</a>
                               ...
                               if(isset($_SESSION["email"])){
                                    ?>
                                 <li class="nav-item">
                                <a  class="btn btn-success" href="logout2.php">Logout</a> 
                                </li>
                              <?php 
                               }
                              else{
                               ?>
                                 <li class="nav-item">
                                <a  class="btn btn-info" href="login2.php">Login</a> 
                                </li>
